...
maindata = load_data.load_main_data(
    "C:\\Users\\Utente\\Desktop\\Elisa\\Research\\2D-vibration\\Phase3\\Results\\data_all_subjects_P3_with0.xlsx"
)
subject_info = load_data.load_data_file(
    "C:\\Users\\Utente\\Desktop\\Elisa\\Research\\2D-vibration\\Phase3\\Results\\Subjects\\Subjects_list_3.xlsx"
)
...
# --------------------------------------------
df = geometry.add_angle_column(df, protocol["grid"]["start_cell"], arm)
